...
cp upper-layer-integration/kestrel/config/kestrel-stixshifter-config.yml "${HOME}"/fedsearchtest/kestrel-stixshifter-config.yaml
...
if kestrel upper-layer-integration/kestrel/test/huntflows/kestrel-test.hf; then
